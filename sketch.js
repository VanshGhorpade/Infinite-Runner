...
function setup() {
    ...
    next = createSprite(width-200,100,100,20)
    next.addImage(nextimg)
    next.visible = false
    next.scale = 0.5

    next1 = createSprite(width-200,300,100,20)
    next1.addImage(nextimg)
    next1.visible = false
    next1.scale = 0.5

    next2 = createSprite(width-200,500,100,20)
    ...
    /*car2=createSprite(width/2+50,height-200)
    ...
    reset = createSprite(width/2,200,50,50)
...
function draw() {
    ...
    if(gameState === "serve"){
       fill("white")
       textSize(30)
       text("NOTE:Press Space ",10,100)
      text("To Start",100,150)
       text("Press Up Arrow",10,250)
        ...
        if(score == 1000){
         ...
         if (track.y > height/2+240){
          ...
          if(keyDown("up")){
            ...
            //obs2.velocityY=obs2.velocityY+10
          }
          createObstacles()
          //keyPressed()
